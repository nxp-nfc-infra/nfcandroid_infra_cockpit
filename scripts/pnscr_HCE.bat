...
::adb shell mv /vendor/lib64/nfc_nci_nxp_snxxx.so /vendor/lib64/nfc_nci_nxp_snxxx.so
...
timeout 3
adb push pnscr_HCE_test.txt /data/nfc/
adb shell pnscr -t 1 -d nxp-nci -f /data/nfc/pnscr_HCE_test.txt
