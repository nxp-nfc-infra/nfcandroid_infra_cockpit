...
typedef struct iFrameInfo {
  bool_t isChained; /*!< I-frame: Indicates if more frames to follow in the same
                       data packet or not */
...
typedef struct phNxpEseProto7816 {
  ...
  phNxpEseProto7816_TransceiveStates_t
      phNxpEseProto7816_nextTransceiveState; /*!< Next Transceive state. It
                                                determines the next action to be
                                                done from host */
  phNxpEseProto7816_State_t
 ...
 */
#define PH_PROTO_WTX_DEFAULT_COUNT 180
/*!
...
/**
 * \ingroup ISO7816-3_protocol_lib
 * \brief This function is used to acquire eSE lock not to enter DPD
 *
 *
 *
 */
