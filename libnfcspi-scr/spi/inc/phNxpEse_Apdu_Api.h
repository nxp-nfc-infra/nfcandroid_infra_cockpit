 ...
 * from the p61. also it parses all required fields of the response PDU.
 *
 ...
 * filled correctly. else proper error code. \retval ESESTATUS_INVALID_PARAMETER
 * - If any invalid buffer passed from application \n \retval
 * ESESTATUS_INSUFFICIENT_RESOURCES - Any problem occurred during allocating the
...
ESESTATUS phNxpEse_7816_APDU_Transceive(uint16_t apduLen, uint8_t *pApdu,
                                        pphNxpEse_7816_rpdu_t pRsp);
