...
/**
 * \ingroup spm_module
 * \brief This function opens the nfc i2c driver to manage power and
 synchronization
 ...
 * \param[out]      none
 *
 * \retval ESESTATUS_SUCCESS on Success #if nfc i2c driver closed successfully
           ESESTATUS_FAILED - i2c driver close failed. \n
 */
 ...
 * \param[out]      none
 *
 * \retval ESESTATUS_SUCCESS on Success if nfc i2c driver
 *         configured the p61.
 *        ESESTATUS_FAILED - Any other error \n
 */
 ...
 *         ESESTATUS_DEVICE_BUSY - The p61 is busy with the wired operation
 *        ESESTATUS_FAILED - Any other error \n
 */
 ...
 *        ESESTATUS_FAILED - if disable power request is failed \n
 */
 ...
 *        ESESTATUS_FAILED - if reset request is failed \n
 */
 ...
 *        ESESTATUS_FAILED - if timeout occured \n
 */
